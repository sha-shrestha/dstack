...
import ai.dstack.core.api.services.CardService
...
import ai.dstack.core.backend.local.server.sqlite.repositories.CardRepository
...
class SQLiteCardService @Autowired constructor(private val repository: CardRepository) : CardService {
    ...
    private fun CardItem.toCard(): Card {
        return this.let { c ->
            ai.dstack.core.api.model.Card(c.dashboard, c.index, c.stack, c.title)
        }
    }
